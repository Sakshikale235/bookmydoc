          ...
          <div className="flex items-center space-x-2">
            {/* <Link to="/symptom_checker">
              <Button  
                variant="outline" 
                size="lg"
                className={`hidden lg:flex items-center space-x-2 transition-all duration-300 hover:scale-[1.05]
                  ${isSymptomCheckerPage 
                    ? "bg-[#56CCF2] border-[#56CCF2] text-white" 
                    : "border-[#1c5a6a] text-[#1c5a6a] hover:bg-[#56CCF2] hover:border-[#56CCF2] hover:text-primary-foreground"
                  }
                `}
              >
